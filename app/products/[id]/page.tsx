  ...
  return (
    <main className="min-h-screen pt-24 bg-transparent flex flex-col relative font-body">
      ...
      <div className="grow w-full max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-px bg-primary/20 relative z-10 border-x ghost-border">
        ...
        {/* Left Column - Visuals */}
        <div className="lg:col-span-7 relative bg-surface-container-lowest flex items-center justify-center p-8 md:p-16 min-h-[60vh] lg:h-[calc(100vh-6rem)] lg:sticky lg:top-24 overflow-hidden">
          ...
          <div className="relative w-full max-w-2xl aspect-square group flex items-center justify-center">
            ...
            <img
              ...
              alt={name}
              className="w-full h-full object-contain mix-blend-screen drop-shadow-2xl transition-all duration-1000 group-hover:scale-[1.1] scale-125 z-10"
            />
          </div>
...
> THE ${name.toUpperCase()} IS A TIER-1 ASSET. DEPLOYMENT REQUIRES EXECUTIVE AUTHORIZATION. ALL SYSTEMS NOMINAL.`}
          ...
          <div className="mt-16 xl:mt-24">
            ...
            <Link href="/contact" className="w-full bg-[#ff003c] hover:bg-white text-white hover:text-black transition-all duration-300 py-4 font-headline text-lg md:text-xl font-bold tracking-widest uppercase relative overflow-hidden group flex items-center justify-center">
