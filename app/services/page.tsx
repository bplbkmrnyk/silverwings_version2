    ...
    <main className="pt-32 pb-24 px-6 md:px-12 lg:px-24 max-w-[1600px] mx-auto relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 relative z-10">
        ...
        <article className="bg-surface-container-low group hover:bg-surface-container-high transition-colors duration-500 relative overflow-hidden flex flex-col h-full ring-1 ring-outline-variant/15">
          ...
          <div className="p-8 lg:p-10 flex-grow flex flex-col relative z-20">
      ...
      <div className="fixed bottom-8 right-8 pointer-events-none opacity-30 flex flex-col items-end gap-1 font-mono text-[10px] text-primary hidden md:flex">
